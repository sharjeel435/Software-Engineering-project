                ...
                <div class="col-md-6 ">
                    ...
                    <ul>
                        ...
                        <li class="navli"><span class="glyphicon glyphicon-phone"></span>
                            <%=um.getPhone_number()%></li>
                        <li class="navli"><span class="glyphicon glyphicon-envelope"></span>
                            <%=um.getEmail()%></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="account_details col-md-10 col-md-offset-1"
                ...
                <table class="table table-user-information col-md-6">
                    ...
                    <tr>
                        <td><b>Amount</b></td>
                        <td>
                            RS: <span id="balance-amount"><%=ac.getBalance()%></span>
                            <i class="glyphicon glyphicon-eye-open" id="toggle-balance" style="cursor: pointer;" onclick="toggleBalance()"></i>
                        </td>
                    </tr>
                    </tbody>
                </table>
